...
//            val matrix: Rep[DenseMatr[Double]] = DenseMatr(LinearAlgebraOps.this.Col.apply[Vec[Double]](WPredef.refArrayOps[WArray[Double]](m).map[DenseVec[Double], WArray[Vec[Double]]](fun(((r: Rep[Array[Double]]) => DenseVec(LinearAlgebraOps.this.Col.apply[Double](r)(((ClassTag.Double): Rep[ClassTag[Double]])))(((ClassTag.Double): Rep[ClassTag[Double]])))))(WArray.canBuildFrom[Vec[Double]](((ClassTag.apply[Vec[Double]](toRep(classOf[scalanizer.linalgebra.Vecs$Vec]))): Rep[ClassTag[Vec[Double]]]))))(((ClassTag.apply[Vec[Double]](toRep(classOf[scalanizer.linalgebra.Vecs$Vec]))): Rep[ClassTag[Vec[Double]]])), width)(((ClassTag.Double): Rep[ClassTag[Double]]));

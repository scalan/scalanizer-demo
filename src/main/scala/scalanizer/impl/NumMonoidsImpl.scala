package scalanizer {
  package implOfNumMonoids {
    object StagedEvaluation {
      ...
      trait NumMonoidsAbs extends NumMonoids with ScalanDsl { self: LinearAlgebraDsl =>
      ...
      trait NumMonoidsExp extends NumMonoidsDsl with ScalanExp { self: LinearAlgebraDslExp =>
  ...
  type _$33
      ...
      trait NumMonoids extends Base { self: LinearAlgebraDsl =>
      ...
      trait NumMonoidsDsl extends NumMonoidsAbs { self: LinearAlgebraDsl =>
        
      };
      trait NumMonoidsDslExp extends NumMonoidsExp { self: LinearAlgebraDslExp =>

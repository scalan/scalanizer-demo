package paradise.linalgebra {
  ...
  type _$6
          ...
          object dot {
            def unapply(d: (Def[_$8] forSome { 
              type _$8
            })): Option[(scala.Tuple4[Rep[DenseVector[T]], Rep[AbstractVector[T]], Rep[Numer[T]], Rep[NumMonoid[T]]] forSome { 
              type T
            })] = d match {
              case MethodCall((receiver @ _), (method @ _), Seq((other @ _), (n @ _), (m @ _), _*), _) if receiver.elem.isInstanceOf[(DenseVectorElem[_$9] forSome { 
  type _$9
})].&&(method.getName.==("dot")) => Some(scala.Tuple4(receiver, other, n, m)).asInstanceOf[Option[(scala.Tuple4[Rep[DenseVector[T]], Rep[AbstractVector[T]], Rep[Numer[T]], Rep[NumMonoid[T]]] forSome { 
                type T
              })]]
              case _ => None
            };
  ...
  type _$22
          ...
          object dot {
            def unapply(d: (Def[_$24] forSome { 
              type _$24
            })): Option[(scala.Tuple4[Rep[AbstractVector[T]], Rep[AbstractVector[T]], Rep[Numer[T]], Rep[NumMonoid[T]]] forSome { 
              type T
            })] = d match {
  ...
  type _$25;
  type _$26
})].&&(method.getName.==("dot")) => Some(scala.Tuple4(receiver, other, n, m)).asInstanceOf[Option[(scala.Tuple4[Rep[AbstractVector[T]], Rep[AbstractVector[T]], Rep[Numer[T]], Rep[NumMonoid[T]]] forSome { 
                type T
              })]]
              case _ => None
            };
      ...
      trait Vectors extends Base { self: LinearAlgebraDsl =>
        trait AbstractVector[T] extends Reifiable[AbstractVector[T]] {
          ...
          def dot(other: Rep[AbstractVector[T]])(implicit n: Rep[Numer[T]], m: Rep[NumMonoid[T]]): Rep[T]
        };
        abstract class DenseVector[T](val items: Rep[Collection[T]])(implicit val ctT: Rep[ClassTag[T]], val eT: Elem[T]) extends AbstractVector[T] with Product with Serializable {
          ...
          def dot(other: Rep[AbstractVector[T]])(implicit n: Rep[Numer[T]], m: Rep[NumMonoid[T]]): Rep[T] = other.items.zip(items).map(fun(((v: Rep[scala.Tuple2[T, T]]) => n.times(v._1, v._2)))).reduce
        };

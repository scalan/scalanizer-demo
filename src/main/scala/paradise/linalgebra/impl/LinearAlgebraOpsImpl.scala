package paradise.linalgebra {
  ...
  type _$8
      ...
      trait LinearAlgebraOps extends Base { self: LinearAlgebraDsl =>
        ...
        trait LACompanion {
          @HotSpot def ddmvm(m: Rep[Array[Array[Double]]], v: Rep[Array[Double]]): Rep[Array[Double]] = {
